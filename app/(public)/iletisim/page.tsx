...
const contactInfo = [
  {
    icon: Mail,
    title: 'E-posta',
    value: 'info@iddaasohbet.com',
    link: 'mailto:info@iddaasohbet.com',
...
const faqs = [
  {
    ...
    answer: 'Kayıt Ol butonuna tıklayarak ücretsiz hesap oluşturabilirsiniz.'
  },
  {
    question: 'Kupon paylaşımı ücretsiz mi?',
    answer: 'Evet, platformumuzda kupon paylaşmak tamamen ücretsizdir.'
  },
  {
    question: 'Verilerim güvende mi?',
    answer: 'Evet, SSL sertifikası ile tüm verileriniz güvence altındadır.'
  }
]
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          className="glass border-white/10 focus:border-green-500/50 bg-black/20 h-12"
                          required
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full glass border-white/10 focus:border-green-500/50 bg-black/20 rounded-lg px-4 py-3 text-foreground placeholder:text-foreground/40 focus:outline-none focus:ring-2 focus:ring-green-500/20"
                        required
                      />
                    </div>
                    ...
                    <Button 
                      type="submit" 
                      size="lg"
                      className="w-full bg-gradient-to-r from-green-500 to-yellow-400 hover:from-green-600 hover:to-yellow-500 text-black font-bold btn-premium h-12"
                    >
          ...
          <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {socialMedia.map((social, index) => (
                    <a
                      key={index}
                      href={social.url}
                      className={`glass p-4 rounded-xl border border-white/5 hover:border-green-500/30 transition-all flex flex-col items-center space-y-2 ${social.color}`}
                    >
            ...
            <Card className="glass-dark border-white/5 card-premium animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
              ...
              <CardContent>
                ...
                <Button 
                  variant="outline" 
                  className="w-full mt-4 border-white/10 hover:border-green-500/50 hover:bg-green-500/10 hover:text-green-400"
                  size="sm"
                >
                  Tüm SSS
                </Button>
